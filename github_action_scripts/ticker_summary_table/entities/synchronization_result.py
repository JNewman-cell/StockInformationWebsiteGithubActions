...
and track the results of ticker summary synchronization operations.
"""
...
class SynchronizationResult:
    ...
    def __init__(self):
        self.to_add: List[TickerSummary] = []  # ticker summaries to add
        self.to_update: List[TickerSummary] = []  # ticker summaries to update
